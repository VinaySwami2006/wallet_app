...
import { AccessibilityInfo as AccessibilityInfo2, findNodeHandle as findNodeHandle2, Platform } from "react-native";
function useRestoreAccessibilityFocus(open, ref) {
  ...
  React2.useEffect(() => {
    ...
    const node = ref.current ? findNodeHandle2(ref.current) : null;
    if (node == null) {
      return;
    }
    const timeout = setTimeout(() => AccessibilityInfo2.setAccessibilityFocus(node), 50);
